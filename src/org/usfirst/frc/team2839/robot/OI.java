...
import org.usfirst.frc.team2839.robot.commands.DriveSpin;
import org.usfirst.frc.team2839.robot.commands.DriveStraight;
...
public class OI {
	...
	public OI(){							//added
		double speed = 0.0;
		double angle =0.0;
		B1.whileHeld(new DriveStraight(speed));
		B2.whileHeld(new DriveSpin(angle));
	}
}
