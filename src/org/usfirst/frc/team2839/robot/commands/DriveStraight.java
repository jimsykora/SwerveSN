...
public class DriveStraight extends Command {
    ...
    public DriveStraight(double rps) {
    ...
    protected void execute() {
    	...
    	Robot.lfSteerPID.setSetpoint(0.0);
    	Robot.lfSteer.setAngle(Robot.lfSteerPID.getOutput());
    	Robot.rfSteerPID.setSetpoint(0.0);
    	Robot.rfSteer.setAngle(Robot.rfSteerPID.getOutput());
    	Robot.rrSteerPID.setSetpoint(0.0);
    	Robot.rrSteer.setAngle(Robot.rrSteerPID.getOutput());
    	Robot.lrSteerPID.setSetpoint(0.0);
    	Robot.lrSteer.setAngle(Robot.lrSteerPID.getOutput());
    	
    	speed = Robot.oi.joystick.getY()*-1.0*100.0/5.5;//*(encoder counts/rev)/(gear reduction)
    	Robot.lfDrivePID.setSetpoint(speed);
